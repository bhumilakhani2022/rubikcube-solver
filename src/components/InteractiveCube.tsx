...
export const InteractiveCube: React.FC<InteractiveCubeProps> = ({ cube, onCubeChange }) => {
  ...
  { label: 'R', move: 'R' },
  { label: "R'", move: "R'" },
  { label: "U", move: "U'" },   // swapped
  { label: "U'", move: "U" },   // swapped
  { label: 'F', move: 'F' },
  { label: "F'", move: "F'" },
  { label: 'L', move: 'L' },
  { label: "L'", move: "L'" },
  { label: 'D', move: "D'" },   // swapped
  { label: "D'", move: "D" },   // swapped
  { label: 'B', move: 'B' },
  { label: "B'", move: "B'" },
];
...
export const PatternLibrary: React.FC<{ cube: Cube; onApplyPattern: () => void }> = ({ 
  ...
  const patterns = [
    ...
    },
    {
      ...
      description: "Creates a single dot on each face"
    },
    {
      name: "Twister",
      moves: ["F", "B'", "U", "F2", "D'", "B", "U2", "F'", "D", "U'", "B", "U", "B'"],
      description: "A twisting pattern"
    },
    {
      name: "Python",
      moves: ["F2", "R", "D'", "B", "U'", "F'", "L", "D", "R'", "B'", "U", "F"],
      description: "A snake-like pattern"
    },
    {
      name: "Plus-Minus",
      moves: ["U2", "D2", "R2", "L2", "F2", "B2"],
      description: "A pattern of plus and minus signs"
    }
  ];
        ...
        <div className="card">
          ...
          <div className="pattern-grid">
            {patterns.map((pattern, index) => (
              <div key={index} className="pattern-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div>
                  <h4>{pattern.name}</h4>
